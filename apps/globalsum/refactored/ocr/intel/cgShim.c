...
//Create Shim
            if(mynode == 0) {
                ocrEdtCreate(&shimEdt, uSB->rtrShimTemplate, EDT_PARAM_DEF, NULL, EDT_PARAM_DEF, NULL, EDT_PROP_NONE, NULL_HINT, NULL);
...
//launch GSi
    u64 GSparamvout[3] = {0, NULL_GUID.guid, NULL_GUID.guid};
    ocrEdtCreate(&GSi, SB->GSiTemplate, EDT_PARAM_DEF, GSparamvout, EDT_PARAM_DEF, NULL, EDT_PROP_NONE, NULL_HINT, NULL);
    ocrDbRelease(depv[1].guid);
